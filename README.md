A simple, interactive Tic-Tac-Toe game built using HTML, CSS, and JavaScript with a sleek UI and smooth animations. Supports player vs. player mode with win, draw detection, and a responsive design.
